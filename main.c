...
#define SERVER_NAME             "a1y7ecqn3447qx-ats.iot.us-east-1.amazonaws.com"
...
#define POSTHEADER "POST /things/aaguedoi_CC3200Board/shadow HTTP/1.1\r\n"
#define GETHEADER "GET /things/aaguedoi_CC3200Board/shadow HTTP/1.1\r\n"
#define HOSTHEADER "Host: a1y7ecqn3447qx-ats.iot.us-east-1.amazonaws.com\r\n"
...
void PrintMessage() {
    ...
    int i;
    for (i = 0; i < 128; i++) {
        drawChar(ind, 110, receivedMessage[i], RED, RED, 2);
        ind += 12;
    }
    messageprint = 1;
}
...
//    "{\"state\": {\"desired\" : {\"var\" : %s}}}\r\n\r\n"
    ...
    snprintf(jsonMessage, sizeof(jsonMessage),
             "{\"state\": {\"desired\" : {\"var\" : \"%s\"}}}\r\n\r\n", sendMessage);
    //char data[] = dataBEGIN + (const char *)sendMessage + dataEND;
    ...
    strcpy(pcBufHeaders,  jsonMessage);
    pcBufHeaders += strlen(jsonMessage);
